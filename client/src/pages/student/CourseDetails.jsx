  ...
  return courseData ? (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        <div className="absolute top-0 left-0 w-full h-section-height -z-10 bg-linear-to-b from-cyan-100/70 to-transparent"></div>
        {/*let Col*/}
        <div className="max-w-xl z-10 text-gray-500">
          ...
          />
          <div className="flex items-center space-x-2 mt-6 pb-2 text-sm">
          ...
          <p className="text-sm">
            Course by{" "}
            <span className="text-blue-600 underline">Learnit.com</span>
          </p>
          <div className="pt-8 text-gray-800">
              ...
              {courseData.courseContent.map((chapter, ind) => (
                ...
                >
                  <div
                    ...
                    className="1 flex items-center justify-between px-4 py-3 cursor-pointer select-none"
                  >
                    <div className="2 flex items-center gap-2">
                      <img
                        className={`transform transition-transform ${openSection[ind] ? "rotate-180" : ""}`}
                  ...
                  <div
                    className={`overflow-hidden transition-all duration-300 ${openSection[ind] ? "max-h-96" : "max-h-0"}`}
                  >
            ...
            <div className="description py-20 text-sm md:text-default">
              <h3 className="text-xl font-semibold text-gray-800">
                Course Description
              </h3>
              <div
                className="pt-3 course-description-content"
                dangerouslySetInnerHTML={{
