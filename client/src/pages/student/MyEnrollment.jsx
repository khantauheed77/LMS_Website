...
const MyEnrollment = () => {
  const {enrolledCourses = [], fetchEnrolledCourses, calculateCourseDuration, navigate} = useContext(AppContext)
  ...
  return ( 
    <>
      ...
      <h1 className='text-2x font-semibold'>My Entrollments</h1>
